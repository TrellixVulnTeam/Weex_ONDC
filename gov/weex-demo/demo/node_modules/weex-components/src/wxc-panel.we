...
<template>
  <div class="panel panel-{{type}}" style="border-width:{{border}}">
    ...
    <text class="panel-header panel-header-{{type}}"
          style="padding-top:{{paddingHead}};
          padding-bottom:{{paddingHead}};
          padding-left:{{paddingHead*1.5}};
          padding-right:{{paddingHead*1.5}}"
          >
      {{title}}
    </text>

    <div class="panel-body panel-body-{{type}}"
         style="padding-top:{{paddingBody}};
         padding-bottom:{{paddingBody}};
         padding-left:{{paddingBody*1.5}};
         padding-right:{{paddingBody*1.5}}">
