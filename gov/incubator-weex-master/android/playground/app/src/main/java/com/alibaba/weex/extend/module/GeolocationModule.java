...
public class GeolocationModule extends WXModule implements Destroyable {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        System.out.println("---GeolocationModule-----onActivityResult------");
    }

    public void onActivityCreate() {
        System.out.println("---GeolocationModule-----onActivityCreate------");
    }

    public void onActivityStart() {
        System.out.println("---GeolocationModule-----onActivityStart------");
    }

    public void onActivityPause() {
        System.out.println("---GeolocationModule-----onActivityPause------");
    }

    public void onActivityResume() {
        System.out.println("---GeolocationModule-----onActivityResume------");
    }

    public void onActivityStop() {
        System.out.println("---GeolocationModule-----onActivityStop------");
    }

    public void onActivityDestroy() {
        System.out.println("---GeolocationModule-----onActivityDestroy------");
    }
