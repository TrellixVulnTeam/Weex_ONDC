...
public class NavigatorModule extends WXModule {
    ...
    public void push(String param, final String callbackId) {
        ...
        no param
        native :  {"url":"android.class://com.example.hippoweex/ui/view/fragment/login/LoginFragment?title=登录"}


        weex :  {"url":"http://121.196.221.73:12580/client/build/person/index.js?title=我的"}


        param

        native:  {"translate":{"country":"china","name":"kevin"},"url":"android.class://com.example.hippoweex/ui/view/fragment/test/TestFragment?title=测试"}

        weex:   {"translate":{"country":"china","name":"kevin"},"url":"http://121.196.221.73:12580/client/build/page-manager.js?title=界面管理"}

        * */
        if (!TextUtils.isEmpty(param)) {
            if (WXSDKEngine.getActivityNavBarSetter() != null) {
                //TODO 解析参数，传递标题信息
                boolean push = WXSDKEngine.getActivityNavBarSetter().push(param);
                if (push) {
    ...
    public void goHome(List<String> tabIndex, final String callbackId) {
        ...
        // wjz - 使用自定义的 navigator 跳转界面
        /*

        weex 传递上来的界面

        [
        "http://121.196.221.73:12580/client/build/information/index.js?title=推荐",
        "http://121.196.221.73:12580/client/build/information/index.js?title=消息",
        "http://121.196.221.73:12580/client/build/person/my/person-home.js?title=云研圈",
        "http://121.196.221.73:12580/client/build/group/index.js?title=组合",
        "http://121.196.221.73:12580/client/build/person/index.js?title=我的"
        ]

        * */

        System.out.println("goHome");
        System.out.println(JSON.toJSONString(tabIndex));
    ...
    public void setNavBarLeftItem(String param, final String callbackId) {
        ...
        /*
        {"left-item-color":"#ffffff","left-item-image":"app://icon_book","left-item-title":"leftText"}

        * */
        System.out.println("setNavBarLeftItem:       "+param);
        if (!TextUtils.isEmpty(param)) {
            if (WXSDKEngine.getActivityNavBarSetter() != null) {
                if (WXSDKEngine.getActivityNavBarSetter().setNavBarLeftItem(param)) {
                    WXBridgeManager.getInstance()
                            .callback(mWXSDKInstance.getInstanceId(), callbackId,
                            MSG_SUCCESS);
                    return;
                }
            }
